/**
 * This class keeps the sales figures for a number of days in an array and provides methods for getting the total
 * and average sales, and the highest and lowest amounts of sales.
 */
