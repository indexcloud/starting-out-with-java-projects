...
/**
 * This program stores mappings in a HashMap and then searches for various objects.
 */
...
public class CarHashMap1 {
    public static void main(String[] args)
    {
        ...
        // Put some mappings into the HashMap. In each mapping, the car's VIN is the key and the Car
        // Object containing that VIN is the value.
