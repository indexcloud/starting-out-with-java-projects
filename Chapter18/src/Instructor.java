...
public class Instructor
{
    ...
    public boolean equals(Object obj)
    {
        ...
        else
        {
            ...
            if (lastName.equalsIgnoreCase(tempInstructor.lastName) &&
                    firstName.equalsIgnoreCase(tempInstructor.firstName) &&
                    officeNumber.equalsIgnoreCase(tempInstructor.officeNumber))
                return true;
            else
                return false;
        }
