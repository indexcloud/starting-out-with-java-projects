...
/**
 * This program uses the RandomAccessFile class to open the file Letters.dat and randomly read letters
...
public class ReadRandomLetters {
    public static void main(String[] args) throws IOException {
        ...
        // Move to character 3 (the 4th character0, read teh character, and display it. Should be the letter d.
        byteNum = CHAR_SIZE * 3;
        randomFile.seek(byteNum);
        ch = randomFile.readChar();
        System.out.println(ch);
